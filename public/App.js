...
const Subtitle = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<h2${spread([$$props], "svelte-f45v0f")}>
  ${$$slots.default ? $$slots.default({}) : ``}
</h2>`;
});
...
const css$f = {
	code: ".content.svelte-bzt96v.svelte-bzt96v{max-width:75ch;margin:auto}.buttons.svelte-bzt96v.svelte-bzt96v{display:flex;justify-content:center}.summary.svelte-bzt96v.svelte-bzt96v{display:flex;flex-flow:column;justify-content:center;padding:25px 0}.name.svelte-bzt96v.svelte-bzt96v{font-weight:bold}.id.svelte-bzt96v.svelte-bzt96v{font-style:italic}.subtitle{width:100%;max-width:40ch;display:flex;justify-content:space-between}.subtitle:last-child{justify-content:flex-end}.summary h2{font-weight:300}@media(min-width: 550px){.summary.svelte-bzt96v.svelte-bzt96v{margin-left:25%}}.buttons.svelte-bzt96v span.svelte-bzt96v{margin-left:15px}span.cross.svelte-bzt96v.svelte-bzt96v{text-decoration:line-through}",
	map: "{\"version\":3,\"file\":\"Confirm.svelte\",\"sources\":[\"Confirm.svelte\"],\"sourcesContent\":[\"<script>\\n  import Header from \\\"components/Header.svelte\\\";\\n  import Button from \\\"components/Button.svelte\\\";\\n  import Subtitle from \\\"components/Typography/Subtitle.svelte\\\";\\n\\n  export let environment;\\n  export let selectedAssets = [];\\n  export let state = {};\\n  export let isSaving = false;\\n  export let onSubmit = () => {};\\n</script>\\n\\n<style>\\n  .content {\\n    max-width: 75ch;\\n    margin: auto;\\n  }\\n\\n  .buttons {\\n    display: flex;\\n    justify-content: center;\\n  }\\n\\n  .summary {\\n    display: flex;\\n    flex-flow: column;\\n    justify-content: center;\\n    padding: 25px 0;\\n  }\\n\\n  .name {\\n    font-weight: bold;\\n  }\\n\\n  .id {\\n    font-style: italic;\\n  }\\n\\n  :global(.subtitle) {\\n    width: 100%;\\n    max-width: 40ch;\\n    display: flex;\\n    justify-content: space-between;\\n  }\\n\\n  :global(.subtitle:last-child) {\\n    justify-content: flex-end;\\n  }\\n\\n  :global(.summary h2) {\\n    font-weight: 300;\\n  }\\n\\n  @media (min-width: 550px) {\\n    .summary {\\n      margin-left: 25%;\\n    }\\n  }\\n\\n  .buttons span {\\n    margin-left: 15px;\\n  }\\n\\n  span.cross {\\n    text-decoration: line-through;\\n  }\\n</style>\\n\\n<div class=\\\"confirm\\\">\\n  <Header title=\\\"Confirm your changes\\\" showNext={false} {state} />\\n  <div class=\\\"content\\\">\\n    <div class=\\\"summary\\\">\\n      {#each selectedAssets as { name, id, env }}\\n        <Subtitle class=\\\"subtitle\\\">\\n          <span>\\n            <span class=\\\"name\\\">{name}</span>\\n            <span class=\\\"id\\\">{id}</span>\\n            :\\n          </span>\\n          <span class=\\\"cross\\\">{env}</span>\\n        </Subtitle>\\n      {/each}\\n      <Subtitle class=\\\"subtitle\\\">promoted to: {environment}</Subtitle>\\n    </div>\\n    <div class=\\\"buttons\\\">\\n      <span class=\\\"cancel\\\">\\n        <Button outline={true} onClick={() => state.reset()}>Cancel</Button>\\n      </span>\\n      <span class=\\\"submit\\\">\\n        <Button\\n          outline={true}\\n          onClick={() => onSubmit(environment, selectedAssets)}>\\n          {isSaving ? 'Saving...' : 'Submit'}\\n        </Button>\\n      </span>\\n    </div>\\n  </div>\\n</div>\\n\"],\"names\":[],\"mappings\":\"AAaE,QAAQ,4BAAC,CAAC,AACR,SAAS,CAAE,IAAI,CACf,MAAM,CAAE,IAAI,AACd,CAAC,AAED,QAAQ,4BAAC,CAAC,AACR,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,MAAM,AACzB,CAAC,AAED,QAAQ,4BAAC,CAAC,AACR,OAAO,CAAE,IAAI,CACb,SAAS,CAAE,MAAM,CACjB,eAAe,CAAE,MAAM,CACvB,OAAO,CAAE,IAAI,CAAC,CAAC,AACjB,CAAC,AAED,KAAK,4BAAC,CAAC,AACL,WAAW,CAAE,IAAI,AACnB,CAAC,AAED,GAAG,4BAAC,CAAC,AACH,UAAU,CAAE,MAAM,AACpB,CAAC,AAEO,SAAS,AAAE,CAAC,AAClB,KAAK,CAAE,IAAI,CACX,SAAS,CAAE,IAAI,CACf,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,aAAa,AAChC,CAAC,AAEO,oBAAoB,AAAE,CAAC,AAC7B,eAAe,CAAE,QAAQ,AAC3B,CAAC,AAEO,WAAW,AAAE,CAAC,AACpB,WAAW,CAAE,GAAG,AAClB,CAAC,AAED,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACzB,QAAQ,4BAAC,CAAC,AACR,WAAW,CAAE,GAAG,AAClB,CAAC,AACH,CAAC,AAED,sBAAQ,CAAC,IAAI,cAAC,CAAC,AACb,WAAW,CAAE,IAAI,AACnB,CAAC,AAED,IAAI,MAAM,4BAAC,CAAC,AACV,eAAe,CAAE,YAAY,AAC/B,CAAC\"}"
};
...
const Confirm = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  <div class="${"content svelte-bzt96v"}">
    <div class="${"summary svelte-bzt96v"}">
      ${each(selectedAssets, ({ name, id, env }) => `${validate_component(Subtitle, "Subtitle").$$render($$result, { class: "subtitle" }, {}, {
		default: () => `
          <span>
            <span class="${"name svelte-bzt96v"}">${escape(name)}</span>
            <span class="${"id svelte-bzt96v"}">${escape(id)}</span>
            :
          </span>
          <span class="${"cross svelte-bzt96v"}">${escape(env)}</span>
        `
	})}`)}
      ${validate_component(Subtitle, "Subtitle").$$render($$result, { class: "subtitle" }, {}, {
		default: () => `promoted to: ${escape(environment)}`
	})}
    </div>
    <div class="${"buttons svelte-bzt96v"}">
      <span class="${"cancel svelte-bzt96v"}">
        ${validate_component(Button, "Button").$$render(
		$$result,
		{
			outline: true,
      ...
      <span class="${"submit svelte-bzt96v"}">
        ${validate_component(Button, "Button").$$render(
		$$result,
		{
			outline: true,
...
${($$result.head += `<meta name="${"viewport"}" content="${"width=device-width, initial-scale=1"}">${($$result.title = `<title>
    ${escape(`${formatTitle(FORM_STEPS[store.currentStep])} - Step ${store.currentStep + 1}/${FORM_STEPS.length} | Multi-Asset Promotion`)}
  </title>`, "")}`, "")}
